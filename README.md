...
# Objects/Mixed Datatypes hw

---

Title: Objects/Mixed Datatypes hw<br>
Type: Homework<br>
...
## Setup
1. Inside your homework folder for tonight, create our html/css/js folder structure, including an `app.js` file.
2. Write your answers in the `app.js` file. Use comments for the non-code responses.
